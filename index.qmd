...
# --- Add Probability Text Directly on Shaded Areas ---
ax.text(1000, 0.16, f'Losing Probability\n{prob_loss:.1%}', 
        ha='center', va='center', fontsize=12, color='#A52A2A', fontweight='bold', bbox=dict(facecolor='white', alpha=0.5, boxstyle='round,pad=0.3'))

ax.text(500000, 0.66, f'Estimated Profit\nProbability\n{prob_profit:.1%}', 
        ha='center', va='center', fontsize=12, color='#006400', fontweight='bold', bbox=dict(facecolor='white', alpha=0.5, boxstyle='round,pad=0.3'))
